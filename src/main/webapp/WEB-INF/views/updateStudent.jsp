        ...
        <c:if test="${not empty student}">
            <form action="updateStudentDetails" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="physics" name="maths" min="0" max="100" value="${student.maths}" required>
                </div>
                <div class="mb-3">
                    <label for="chemistry" class="form-label">Chemistry</label>
                    <input type="number" class="form-control" id="chemistry" name="computer" min="0" max="100" value="${student.computer}" required>
                </div>
